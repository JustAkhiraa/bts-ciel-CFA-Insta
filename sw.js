...
const VERSION='bts-ciel-8c2067f2e8';
const COQUILLE=["./", "./index.html", "./outils.html", "./a-propos.html", "./manifest.webmanifest", "./assets/icone.svg", "./assets/fiche.css?v=eb0d29a1", "./assets/app.js?v=eb0d29a1", "./assets/fiche.js?v=eb0d29a1", "./assets/recherche.js?v=eb0d29a1", "./assets/logo-classe.jpg", "./assets/fond-voxel.webp", "./01-informatique-dev/index.html", "./02-reseaux-systemes/index.html", "./03-mathematiques/index.html", "./04-anglais/index.html", "./05-culture-generale/index.html"];
