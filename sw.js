...
const VERSION='bts-ciel-e08762f541';
const COQUILLE=["./", "./index.html", "./a-propos.html", "./outils/index.html", "./outils/convertisseur.html", "./outils/masques.html", "./manifest.webmanifest", "./assets/icone.svg", "./assets/fiche.css?v=6c607acc", "./assets/app.js?v=6c607acc", "./assets/fiche.js?v=6c607acc", "./assets/recherche.js?v=6c607acc", "./assets/logo-classe.jpg", "./assets/fond-voxel.webp", "./01-informatique-dev/index.html", "./02-reseaux-systemes/index.html", "./03-mathematiques/index.html", "./04-anglais/index.html", "./05-culture-generale/index.html"];
